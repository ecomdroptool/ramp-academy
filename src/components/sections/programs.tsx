        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {programs.map((program, i) => (
            <motion.div
              ...
              className={`card-lift relative rounded-2xl border bg-white p-8 flex flex-col ${
                program.featured
            ...
            >
              ...
              >
                <program.icon
                  size={22}
                  className={
                    program.featured ? "text-void" : "text-muted-text"
                  }
                />
              </div>
              ...
              <p className="mt-1 font-display text-2xl font-black text-void">
                {program.price}
              </p>
              ...
              <a
                href={program.href}
                className={`mt-6 inline-flex items-center justify-center gap-2 rounded-full px-6 h-11 text-sm font-semibold transition-all group ${
                  program.featured
