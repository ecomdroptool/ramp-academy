    ...
    <section className="relative py-24 sm:py-32 bg-void overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        >
          ...
          <p className="mt-4 text-white/35 text-lg max-w-xl mx-auto">
          ...
          <div className="mt-10">
            <a href="#">
              <Button
                size="lg"
                className="bg-lime text-void font-semibold hover:bg-lime-dark rounded-full px-10 h-14 text-lg border-0 cursor-pointer group"
              >
          ...
          <motion.div
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-5 py-2.5"
          >
