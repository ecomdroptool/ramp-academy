...
const footerLinks = {
  Programas: [
    { label: "Primeiro App Lucrativo", href: "#programas" },
...
export function Footer() {
  return (
    <footer className="bg-void pt-2 pb-8">
      <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-6 flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/40 transition-colors hover:bg-lime/10 hover:text-lime"
                >
                  {social.icon}
                </a>
              ))}
        ...
        {/* Bottom bar */}
        <Separator className="bg-white/5 mt-16 mb-6" />
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/20">
          <p>© {new Date().getFullYear()} RAMP Academy. Todos os direitos reservados.</p>
